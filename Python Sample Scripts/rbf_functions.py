...
class PARAMETERS:
    def __init__(self, polydeg, phsdeg, cloud_size_mult, meshfile):
        ...
        self.num_poly_terms=None; self.cloud_size=None;
...
class POINTS:
    def __init__(self, parameters):
        ...
        self.nv=self.xyz.shape[0];
        parameters.num_poly_terms=math.comb(parameters.polydeg + 2, 2)
...
class CLOUD:
    ...
    def calc_coeff(self, parameters, points):
        ...
        for iv in range(points.nv):
            ...
            self.laplacian_coeff[iv,:] = coeff[:,2]
